  ...
  return (
    ...
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
                {!account && <button class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-yellow-200 md:p-0" onClick={activateBrowserWallet}> connect wallet</button>}
                {account && <button class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-yellow-200 md:p-0"onClick={deactivate}>disconnect wallet</button>}        
            </li>
        </ul>
        </div>
    </div>
